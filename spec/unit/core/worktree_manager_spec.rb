...
RSpec.describe Sxn::Core::WorktreeManager do
  ...
  describe "#add_worktree" do
    ...
    it "raises error when no active session" do
      ...
      expect {
        worktree_manager.add_worktree("test-project")
      }.to raise_error(Sxn::NoActiveSessionError, /No active session/)
    end
    ...
    it "raises error when project not found" do
      ...
      }.to raise_error(Sxn::ProjectNotFoundError, "Project 'non-existent-project' not found")
    end
    ...
    it "raises error when worktree already exists" do
      ...
      expect {
        worktree_manager.add_worktree("test-project")
      }.to raise_error(Sxn::WorktreeExistsError, /already exists in session/)
    end
    ...
    it "handles git worktree creation failure" do
      ...
      expect {
        worktree_manager.add_worktree("test-project")
      }.to raise_error(Sxn::WorktreeCreationError, /Failed to create worktree/)
    end
  ...
  describe "#remove_worktree" do
    ...
    it "raises error when worktree not found" do
      ...
      expect {
        worktree_manager.remove_worktree("test-project")
      }.to raise_error(Sxn::WorktreeNotFoundError, /not found in session/)
    end
    ...
    it "handles git command failure gracefully" do
      ...
      expect {
        worktree_manager.remove_worktree("test-project")
      }.to raise_error(Sxn::WorktreeRemovalError, /Failed to remove worktree/)
    end
    ...
    let(:worktrees_data) do
      {
        ...
        "project2" => { path: File.join(session_path, "project2"), branch: "feature", created_at: "2023-01-02T00:00:00Z" }
      }
    end
  ...
  describe "additional coverage" do
    ...
    describe "#add_worktree edge cases" do
      ...
      it "cleans up on failure" do
        ...
        expect {
          worktree_manager.add_worktree("test-project")
        }.to raise_error(Sxn::WorktreeCreationError)
    ...
    describe "#get_worktree_status" do
      ...
      it "returns 'clean' for clean git repository" do
        ...
        Dir.chdir(test_path) do
          ...
          if !system("git diff-index --quiet --cached HEAD", out: File::NULL, err: File::NULL)
        ...
        expect(["clean", "untracked"]).to include(status)
      end
