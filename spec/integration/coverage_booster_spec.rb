...
RSpec.describe "Coverage Booster Integration Tests" do
  ...
  describe "Class instantiation" do
    ...
    it "can instantiate template classes" do
      ...
      expect { Sxn::Templates::TemplateSecurity.new(project_path) }.not_to raise_error
      expect { Sxn::Templates::TemplateVariables.new(project_path: project_path, session_path: session_path) }.not_to raise_error
    end
